...
public interface IOKit extends Library {
	 ...
	 */
	final String kIOPMAssertPreventUserIdleSystemSleep = "PreventUserIdleSystemSleep";
	 ...
	 * This assertion has no effect if the system is in Dark Wake.
	 */
	final String kIOPMAssertPreventUserIdleDisplaySleep = "PreventUserIdleDisplaySleep";
	 ...
	 */
	final String kIOPMAssertPreventDiskIdle = "PreventDiskIdle";
	 ...
	 */
	final String kIOPMAssertNetworkClientActive = "NetworkClientActive";

	/** This value represents a non-initialized assertion ID */
	final int kIOPMNullAssertionID = 0;

	/** Level for a disabled assertion */
	final int kIOPMAssertionLevelOff = 0;

	/** Level for an enabled assertion */
	final int kIOPMAssertionLevelOn = 255;
	 ...
	 */
	final String kIOPMAssertionTimeoutKey = "TimeoutSeconds";
	 ...
	 * {@link #IOPMAssertionCopyProperties}.
	 */
	final String kIOPMAssertionTimeoutActionKey = "TimeoutAction";
	 ...
	 */
	final String kIOPMAssertionTimeoutActionLog = "TimeoutActionLog";
	 ...
	 * {@link #kIOPMAssertionLevelOff}.
	 */
	final String kIOPMAssertionTimeoutActionTurnOff = "TimeoutActionTurnOff";

	/**
	 * When a timeout expires with this action, Power Management will log the
	 * timeout event, and will release the assertion.
	 */
	final String kIOPMAssertionTimeoutActionRelease = "TimeoutActionRelease";
	 ...
	 * {@link #IOPMAssertionCopyProperties}.
	 */
	final String kIOPMAssertionRetainCountKey = "RetainCount";
	 ...
	 * </ul>
	 */
	final String kIOPMAssertionNameKey = "AssertName";
	 ...
	 * </ul>
	 */
	final String kIOPMAssertionDetailsKey = "Details";
	 ...
	 * </ul>
	 */
	final String kIOPMAssertionHumanReadableReasonKey = "HumanReadableReason";
	 ...
	 * {@link #IOPMAssertionCopyProperties}.
	 */
	final String kIOPMAssertionLocalizationBundlePathKey = "BundlePath";
	 ...
	 * {@link #IOPMAssertionCopyProperties}.
	 */
	final String kIOPMAssertionFrameworkIDKey = "FrameworkBundleID";
	 ...
	 * {@link #IOPMAssertionCopyProperties}.
	 */
	final String kIOPMAssertionPlugInIDKey = "PlugInBundleID";
	 ...
	 */
	final String kIOPMAssertionTypeKey = "AssertType";
	 ...
	 */
	final String kIOPMAssertionLevelKey = "AssertLevel";

	/**
	 * This assertion type is identical to
	 * {@link #kIOPMAssertPreventUserIdleSystemSleep} Please use that instead.
	 */
	final String kIOPMAssertionTypePreventUserIdleSystemSleep = kIOPMAssertPreventUserIdleSystemSleep;

	/**
	 * This assertion type is identical to
	 * {@link #kIOPMAssertPreventUserIdleDisplaySleep} Please use that instead.
	 */
	final String kIOPMAssertionTypePreventUserIdleDisplaySleep = kIOPMAssertPreventUserIdleDisplaySleep;
	...
	public enum IOPMUserActiveType implements JnaIntEnum<IOPMUserActiveType> {
		...
		/**
		 * @param the {@code IOPMUserActiveType} integer value.
