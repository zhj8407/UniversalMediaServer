...
//			}
	...
	private static void getFormat(StreamType streamType, DLNAMediaInfo media, DLNAMediaAudio audio, String value, File file) {
		...
		} else if (value.equals("wmv3")) {
			format = FormatConfiguration.VC1;
		} else if (value.equals("wvc1") || value.equals("wmva")) {
			format = FormatConfiguration.WMVAP;
...
//			media.setContainer(FormatConfiguration.MP2);
		...
		} else if (value.equals("twinvq")) {
			format = FormatConfiguration.VQF;
		} else if (
			(
				value.equals("dts") ||
				value.equals("a_dts") ||
